\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Distribution of predicted human probabilities $P(\text{Human} \mid \textbf x)$ on the test dataset (408 human, 260 murine). Most predictions concentrate near 0 and 1, with very few ambiguous cases around 0.5.}
