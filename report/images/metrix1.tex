\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Classification accuracy versus quadratic certainty score $\mathcal Q$ for the custom piecewise kernels on the test dataset (\hyperref[sec:piecewise_results_table]{full values in appendix}).}
