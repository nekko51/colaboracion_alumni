...
\begin{document}
    ...
    \begin{tikzpicture}
        ...
        % Piecewise function (C=0.82, W=0.08 -> center=244.36, width=23.84)
        \addplot [color=cyan!80!black, dashed] {
            (x < 232.44) * (0.2 / 232.44 * x) +
            (x >= 232.44 && x <= 256.28) * (0.6 / 23.84 * (x - 232.44) + 0.2) +
            (x > 256.28) * (0.2 / 41.72 * (x - 256.28) + 0.8)
        };
        \addlegendentry{Piecewise ($C=0.82$)}
    ...
    \begin{tikzpicture}
        ...
        % Piecewise function translated
        \addplot [color=cyan!80!black, dashed] {
            ((298 - x^2/2) < 232.44) * (0.2 / 232.44 * (298 - x^2/2)) +
            ((298 - x^2/2) >= 232.44 && (298 - x^2/2) <= 256.28) * (0.6 / 23.84 * ((298 - x^2/2) - 232.44) + 0.2) +
            ((298 - x^2/2) > 256.28) * (0.2 / 41.72 * ((298 - x^2/2) - 256.28) + 0.8)
        };
        \addlegendentry{Piecewise ($C=0.82$)}
