...
void svm_initNgram(char *file_name, char kernel_char) {
    ...
    sprintf(result_gram, "results/svm/gram/gram_matrix_%s.txt", file_name);
 ...
 */
void svm_initNannealing(double epsilon, int its_each_beta, int n_betas, int initial_beta_its, int print_svm_to_file) {
    printf("\nstarting initialization...\n");
