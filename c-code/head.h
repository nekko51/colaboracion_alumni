...
void generate_betas(double** betas, int n_betas, double* entropies, int n_entropies, double scale_factor, double epsilon, double cooling_rate, 
    const CDRRegion* cdr_regions, int n_cdrs);
...
void mega_metropolis(char* murine_seeds_filename, char* human_filename, int n_human_lines, int n_sweeps, double** betas, int n_betas, 
    int n_metropolis, double cdr_threshold, const CDRRegion* cdr_regions, int n_cdrs,double scale_factor, double cooling_rate, double entropy_q);
